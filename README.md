...
2. Enter `git clone https://github.com/AoTTG-2/Aottg2-Unity.git` (this is the official AoTTG2 link, make sure to swap it for the Prolonpo version for the git link - https://github.com/Prolonpo/Aottg2-Prolonpo.git)
